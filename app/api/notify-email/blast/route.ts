...
const TITLE = "A note from ScoreSynth";
const BODY = `Hi! Thank you for being part of ScoreSynth. Every day we upload new sheet music to the community, and we're also working on a browser-based score editor and new tools for transcription and AI composition — more on that soon.\n\nWe also want to let you know that we've updated our profile security. Your public handle was changed — the previous one could reveal part of your email address. You can choose a new handle in your profile settings.\n\n— The ScoreSynth Team`;

function buildHtml(body: string, title: string) {
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
        <tr>
          <td style="padding:0 0 24px;text-align:center;">
            <a href="https://scoresynth.com" style="text-decoration:none;">
              <img src="https://scoresynth.com/logo-scoresynth-email.png" width="180" alt="ScoreSynth" style="display:inline-block;"/>
            </a>
          </td>
        </tr>
        <tr>
            ...
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
              <tr>
                <td style="background:#c0392b;border-radius:12px;">
                  <a href="https://scoresynth.com/community" style="display:inline-block;padding:14px 40px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.5px;">
                    Open ScoreSynth
                  </a>
                </td>
              </tr>
        ...
        <tr>
          <td style="background:#1a1210;border-radius:0 0 16px 16px;padding:24px 44px 32px;border:1px solid rgba(255,255,255,0.07);border-top:none;text-align:center;">
            <p style="margin:0 0 6px;font-size:12px;font-family:Arial,sans-serif;color:rgba(255,255,255,0.25);">
              &copy; 2025 ScoreSynth &nbsp;&middot;&nbsp;
              <a href="https://scoresynth.com" style="color:rgba(255,255,255,0.4);text-decoration:none;">scoresynth.com</a>
              &nbsp;&middot;&nbsp;
              <a href="https://scoresynth.com/privacy" style="color:rgba(255,255,255,0.4);text-decoration:none;">Privacy</a>
            </p>
