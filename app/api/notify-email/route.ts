...
function buildEmailHtml(n: NotificationRecord): string {
  const typeConfig: Record<string, { label: string; icon: string; ctaText: string; ctaUrl: string }> = {
    message: {
      ...
      ctaUrl: "https://scoresynth.com/community/messages",
    ...
    like: {
      ...
      ctaText: "View Score",
      ctaUrl: n.score_id ? `https://scoresynth.com/community/${n.score_id}` : "https://scoresynth.com/community",
