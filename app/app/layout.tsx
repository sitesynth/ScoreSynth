...
function getBreadcrumb(pathname: string) {
  if (pathname === "/app") return "Recents";
  if (pathname === "/app/projects") return "All projects";
  if (pathname.startsWith("/app/projects/")) return "All projects / Project";
  if (pathname === "/app/saved") return "Saved Compositions";
  if (pathname === "/app/trash") return "Trash";
  if (pathname === "/app/community") return "Community / My Community Profile";
  return "";
}
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <Link href="/app/projects" style={{
                  ...
                  padding: "8px 10px", borderRadius: "8px",
                  fontSize: "13px", fontWeight: isActive("/app/projects") ? 500 : 400,
                  color: isActive("/app/projects") ? "#fff" : "#a89690",
                  background: isActive("/app/projects") ? "rgba(176,48,37,0.88)" : "transparent",
                  textDecoration: "none", transition: "background 0.15s, color 0.15s",
                }}
                  onMouseEnter={e => { if (!isActive("/app/projects")) { e.currentTarget.style.background = "rgba(255,255,255,0.05)"; e.currentTarget.style.color = "#e8dbd8"; } }}
                  onMouseLeave={e => { if (!isActive("/app/projects")) { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#a89690"; } }}
                >
