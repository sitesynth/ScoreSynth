        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 32px 80px" }} className="mob-px">
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="mob-1col tab-2col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
              {PIANO_SCORES.map(s => <ScoreCard key={s.id} score={s} />)}
            </div>
          </section>
          ...
          <section style={{ marginBottom: "64px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "20px" }}>
              ...
              <Link href="#" style={{ fontSize: "13px", color: "#6b8fbd", textDecoration: "none", whiteSpace: "nowrap" }}>
                Browse all scores →
              </Link>
            </div>
            <div className="mob-1col tab-2col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
              {BRASS_SCORES.map(s => <ScoreCard key={s.id} score={s} />)}
            </div>
          </section>
